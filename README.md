...
You may also download [`autocomplete/bash_autocomplete`](https://raw.githubusercontent.com/piensa/gnd/master/autocomplete/bash_autocomplete) into `/etc/bash_completion.d/` and rename it to `mc`. Don't forget to source the file to make it active on your current shell.
...
Please follow Minio [Contributor's Guide](https://github.com/piensa/gnd/blob/master/CONTRIBUTING.md)
